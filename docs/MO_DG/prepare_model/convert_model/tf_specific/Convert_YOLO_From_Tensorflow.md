...
OpenVINO&trade; toolkit provides a demo that uses YOLOv3 model. For more information, refer to [Object Detection C++ Demo](https://docs.openvinotoolkit.org/latest/omz_demos_object_detection_demo_cpp.html).
