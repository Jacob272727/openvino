...
* [Mask R-CNN Sample for TensorFlow* Object Detection API Models](https://docs.openvinotoolkit.org/latest/omz_demos_mask_rcnn_demo_cpp.html) --- for Mask R-CNNs
...
One of these two nodes produces output mask tensors. The child nodes of these nodes are related to post-processing which is implemented in the [Mask R-CNN demo](https://docs.openvinotoolkit.org/latest/omz_demos_mask_rcnn_demo_cpp.html) and should be cut off.
